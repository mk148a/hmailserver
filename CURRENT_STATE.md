...
- Push status: local code/test commit `74ca89853` and documentation commit pending normal push; last verified upstream is `3b547051b`
- Current HEAD: `74ca89853` (code/test; documentation commit pending)
- Last successfully pushed commit: `3b547051b`
- Latest focused-test result: domain restore cleanup tests `6 passed, 3 skipped, 0 failed`
- Latest full Net10 result: default `1934 passed, 0 failed, 29 skipped`
...
- Next three independent slices: wire transaction-scoped domain cleanup into full-restore ordering with rollback tests; implement public-folder deletion and reinitialization ordering on disposable targets; implement native handle-relative restore swap/copy containment
