...
Backlog'daki siradaki ana dilim: halihazirda process-local host tarafindan sunulan `Application`, `Settings` ve `MessageIndexing` siniflari icin service install/uninstall registry ve type-library wiring'ini tamamlamak. Legacy CLSID'ler, versioned/version-independent ProgID'ler ve CurVer alias'lari deklaratif ve testlenebilir bicimde eklenmeli; gelistirici makinesinin registry'sine test sirasinda dokunulmamali. Database-backed Settings/account uyeleri sonraki sinirli dilimlere birakilmali.
