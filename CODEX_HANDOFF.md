...
- External POP3 fetch icin SQL lease/UID store, POP3 network session, UIDL/RETR/DELE/QUIT akis, recipient resolution, yeni/bilinen UIDL duplicate baskilama, spam/AV entegrasyonu ve `OnExternalAccountDownload` script hook'u eklendi.
