...
[TestClass]
public sealed class WebAdminAjaxSpamAssassinPostOnlySourceTests
{
    [TestMethod]
    public void AjaxSpamAssassinTestHandlerRequiresPostAndCsrf()
    {
        var source = ReadFile("background_ajax_spamassassintest.php");
