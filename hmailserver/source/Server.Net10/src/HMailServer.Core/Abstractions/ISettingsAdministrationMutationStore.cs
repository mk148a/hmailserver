...
public interface ISettingsAdministrationMutationStore
{
    ...
    ValueTask<bool> UpdateAntiVirusNotifySenderAsync(
        bool notifySender,
        CancellationToken cancellationToken);

    ValueTask<bool> UpdateAntiVirusCustomScannerEnabledAsync(
        bool enabled,
        CancellationToken cancellationToken);
    ...
    ValueTask<bool> UpdateAntiVirusCustomScannerReturnValueAsync(
        int returnValue,
        CancellationToken cancellationToken);

    ValueTask<bool> UpdateAntiVirusMaximumMessageSizeAsync(
    ...
    ValueTask<bool> UpdateAntiVirusClamAvEnabledAsync(
        bool enabled,
        CancellationToken cancellationToken);

    ValueTask<bool> UpdateAntiVirusClamAvHostAsync(
        string host,
        CancellationToken cancellationToken);
