                ...
                : HMailServer.ComInterop.BackupSettings.CreateAuthorized(
                    ...
                    updateDestination: _settingsMutationStore is null
                        ...
                        : value => _settingsMutationStore!
                            ...
                            .GetAwaiter()
                            .GetResult(),
                    updateBackupSettings: _settingsMutationStore is null
                        ? null
                        : value => _settingsMutationStore!
                            .UpdateBackupSettingsAsync(value, CancellationToken.None)
                            .GetAwaiter()
                            .GetResult(),
                    updateBackupDomains: _settingsMutationStore is null
                        ? null
                        : value => _settingsMutationStore!
                            .UpdateBackupDomainsAsync(value, CancellationToken.None)
                            .GetAwaiter()
                            .GetResult(),
                    updateBackupMessages: _settingsMutationStore is null
                        ? null
                        : value => _settingsMutationStore!
        ...
        get
        {
            ...
            return _administrationSnapshot is null
                ...
                : HMailServer.ComInterop.AntiVirus.CreateAuthorized(
                    ...
                    publishClamWinExecutable: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                    ...
                    publishNotifySender: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                            {
                                AntiVirusNotifySender = value
                            };
                        }
                    },
                    publishCustomScannerEnabled: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                            {
                                AntiVirusCustomScannerEnabled = value
                            };
                        }
                    },
                    publishCustomScannerExecutable: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                            {
                                AntiVirusCustomScannerExecutable = value
                            };
                        }
                    },
                    publishCustomScannerReturnValue: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                            {
                                AntiVirusCustomScannerReturnValue = value
                            };
                        }
                    },
                    ...
                    publishClamAvPort: value =>
                    {
                        if (_administrationSnapshot is not null)
                        {
                            _administrationSnapshot = _administrationSnapshot with
                            {
                                AntiVirusClamAvPort = value
                            };
                        }
                    });
        }
