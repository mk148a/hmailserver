...
public sealed class SqlServerImapSearchPlanner
{
    public SqlSearchPlan Plan(ImapSearchRequest request)
    {
...
""");
        ...
        var requiredFlags = request.RequiredFlags;
        var forbiddenFlags = request.ForbiddenFlags;
        AddSessionRecentFilters(sql, parameters, request.SessionRecentUids, ref requiredFlags, ref forbiddenFlags);
        ...
        sql.AppendLine("ORDER BY m.messageuid ASC;");
